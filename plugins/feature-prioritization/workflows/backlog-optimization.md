...
**Commands**:
```
/requirements-engineering:user-stories [feature description]
/agile-coaching:backlog-groom --top 20
```
...
**Commands**:
```
/agile-coaching:sprint-plan "Next Sprint"
/strategic-planning:roadmap "Next Quarter"
```
