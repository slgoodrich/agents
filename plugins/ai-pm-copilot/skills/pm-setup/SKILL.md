---
name: pm-setup
description: "Initialize .claude/product-context/ with essential product information for all PM agents. Use when setting up PM context, bootstrapping product info, or running first-time PM configuration. Trigger on: '/pm-setup', 'set up product context', 'initialize PM', 'configure product info'."
user-invocable: true
...
See `references/validation-and-errors.md` for:
- Required field validation per file
- Missing information prompts
- File write error recovery
- Agent invocation fallbacks
