...
```
/pm:kpi-dashboard [product or feature name] [optional: dashboard type]
```
...
- `/pm:roadmap` - Prioritize based on metric impact
- `/workflows:monthly-business-review` - Monthly metrics review workflow
