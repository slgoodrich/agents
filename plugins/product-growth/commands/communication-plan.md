...
```
/pm:comm-plan [initiative or change] [stakeholders]
```
...
- `/pm:stakeholder-map` - Map stakeholders for communication
- `/pm:align` - Alignment meetings for stakeholder buy-in
- `/pm:release-plan` - Release communication planning
