...
**Commands**:
```
/user-research:research-synthesize [research data]
```
...
**Commands**:
```
/strategic-planning:roadmap "Updated with Research Insights"
/requirements-engineering:prd [top priority feature]
