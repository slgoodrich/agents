...
**Commands**:
```
/user-research:interview-guide "Problem discovery for [problem]"
...
**Commands**:
```
/user-research:research-synthesize [interview notes]
/customer-insights:persona [target user]
/customer-insights:journey-map [scenario]
```
...
**Commands**:
```
/requirements-engineering:user-stories [solution concept]
```
...
/requirements-engineering:prd [validated solution]
```
