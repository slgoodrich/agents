...
```
/stakeholder-management:decision-log [decision topic] [optional: context, participants]
```
...
**Related**: `/product-operations:quick-answer`, `/requirements-engineering:prd`, `/requirements-engineering:technical-spec`
