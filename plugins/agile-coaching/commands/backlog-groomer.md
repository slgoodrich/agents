...
```
/agile-coaching:backlog-groom [optional: epic, theme, or "all"]
```
...
**Related**: `/agile-coaching:sprint-plan`, `/requirements-engineering:user-stories`, `/feature-prioritization:quick-prioritize`
