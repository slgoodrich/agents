...
```
/product-analytics:experiment [hypothesis or feature to test] [optional: context, metrics]
```
...
- `/product-analytics:impact` - Estimate expected impact before experiment
- `/product-analytics:metrics` - Define KPIs and success metrics
- `/growth-strategy:growth-sprint` - Growth experimentation workflow
