...
```
/requirements-engineering:prd [feature description or problem statement] [optional: context, constraints]
```
...
- `/requirements-engineering:user-stories` - Convert PRD requirements into user stories
- `/continuous-discovery:mvp` - Scope MVP for v1 of PRD
- `/product-analytics:impact` - Estimate impact of PRD features
- `/strategic-planning:risks` - Detailed risk assessment for PRD
- `/stakeholder-management:align` - Get stakeholder alignment on PRD
- `/requirements-engineering:feature-lifecycle` - End-to-end feature development from PRD to launch
