...
```
/requirements-engineering:technical-spec [feature or system name] [optional: spec type, complexity]
```
...
- `/requirements-engineering:prd` - Product requirements driving the spec
- `/api-product-management:api-documentation` - For API-specific docs
- `/stakeholder-management:decision-log` - Document technical decisions
