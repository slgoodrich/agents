...
```
/strategic-planning:roadmap [product or initiative name] [optional: timeframe]
```
...
**Commands**:
- `/strategic-planning:okr` - Create OKRs that align with roadmap themes
- `/feature-prioritization:prioritize` - Score and rank initiatives for roadmap
- `/requirements-engineering:prd` - Detailed product requirements for roadmap initiatives
