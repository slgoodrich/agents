...
```
/strategic-planning:scenarios [decision or plan] [optional: time horizon, key variables]
```
...
- `/strategic-planning:risks` - Risk assessment for scenario planning inputs
- `/product-analytics:impact` - Impact estimation for scenario outcomes
- `/stakeholder-management:decision-log` - Document scenario-based decisions
- `/strategic-planning:quarterly-planning` - Use scenarios in quarterly planning
