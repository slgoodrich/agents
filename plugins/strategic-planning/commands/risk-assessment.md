...
```
/strategic-planning:risks [feature or project name] [optional: context, timeline]
```
...
- `/continuous-discovery:mvp` - Scope MVP considering risks
- `/strategic-planning:scenario-planner` - Scenario planning for risk outcomes
- `/stakeholder-management:decision-log` - Document risk decisions
