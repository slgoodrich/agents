...
```
/strategic-planning:exec-summary [topic or project] [optional: audience level, format]
```
...
- `/product-operations:status` - Status updates (more tactical)
- `/stakeholder-management:decision-log` - Document decisions mentioned
- `/product-operations:meeting-agenda` - Prepare for exec meetings
- `/stakeholder-management:stakeholder-map` - Executive stakeholder management
- `/strategic-planning:annual-planning` - Monthly executive summaries
