---
name: Feature Lifecycle Workflow
...
**Discovery**:
- `/pm:interview-guide` - Research planning
- `/pm:research-synthesize` - Analysis

**Specification**:
- `/pm:prd` - PRD generation
- `/pm:user-stories` - Story creation
...
- `/pm:backlog-groom` - Backlog prep

**Launch**:
- `/pm:release-notes` - Announcements
- Tell `gtm-planner` - GTM execution

**Learn**:
- `/pm:kpi-dashboard` - Metrics
- `/pm:experiment` - Optimization tests
...
→ /pm:sprint-plan "Sprint 47: MFA Phase 1"
