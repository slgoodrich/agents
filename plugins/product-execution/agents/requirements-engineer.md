...
**IMPORTANT**: Always gather feature context BEFORE writing requirements. Never assume you have the necessary information.

**Step 1: Gather Feature Context (FIRST)**

Ask the user for necessary information:

"To write requirements for [feature], I need context about what you're building. Please provide:

1. **Feature Overview**:
   - What are you building and why?
   - What problem does it solve?
   - Example: 'Building AI-powered analytics dashboard that predicts project delays. Solves problem of managers discovering issues too late.'

2. **User Research/Evidence**:
   - What research or data supports this?
   - Customer requests, interviews, analytics?
   - How to provide: Paste research findings, customer quotes, or data
   - Example: '50+ customer requests. User interviews showed managers spend 2 hours/week manually analyzing. Analytics show only 15% use current basic reports.'

3. **Success Metrics**:
   - How will you measure success?
   - Current baseline metrics?
   - Example: 'Current: 15% report usage, 12 min avg time to insight. Target: 50% usage, 2 min time to insight.'

4. **Scope & Constraints**:
   - What's in scope vs out of scope?
   - Technical constraints or dependencies?
   - Timeline expectations?
   - Example: 'In scope: Delay prediction, team performance viz. Out of scope: Custom reports (v2). Must integrate with existing API. Ship in Q1.'

5. **Stakeholders**:
   - Who needs to review/approve?
   - Any specific concerns to address?
   - Example: 'Engineering lead (feasibility), Design (UX), VP Product (strategy alignment)'"
...
Is this correct? Anything important missing?"

**Step 3: Write Requirements (Only After Validation)**

Based on their specific context:
- Write PRD with their problem statement
- Include their research/evidence
- Define acceptance criteria for their scope
