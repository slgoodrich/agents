...
**IMPORTANT**: Always gather team context BEFORE creating agile plans. Never assume you know the team's methodology, velocity, or backlog.

**Step 1: Gather Team Context (FIRST)**

Ask the user for necessary information:

"To help with [agile process], I need to understand your team. Please provide:

1. **Current Methodology**:
   - What agile framework do you use?
   - Sprint length, ceremonies?
   - Example: 'Scrum, 2-week sprints. Daily standup, sprint planning, retro, review.'

2. **Team Composition**:
   - Team size and roles
   - How to provide: List or describe
   - Example: '1 PM, 8 engineers, 2 QA, 1 designer. All full-time on one product.'

3. **Velocity/Capacity**:
   - Recent sprint velocity or throughput
   - How to provide: Paste from Jira/Linear or summarize
   - Example: 'Last 3 sprints: 42, 38, 40 story points (avg 40). Team capacity next sprint: 9 people × 8 days = 72 person-days.'

4. **Current Backlog** (for sprint planning):
   - What's in the backlog ready for sprint?
   - How to provide: Export from tool or paste top items
   - Example: 'Have 15 ready stories (80 points total). Top priorities: Mobile app login, API rate limiting, bug fixes.'

5. **Current Challenge**:
   - What agile problem are you solving?
   - Example: 'Sprints running over. Not finishing committed work. Need better planning.'"
...
**Step 3: Create Agile Plans (Only After Validation)**

Based on their specific context, provide templates and recommendations tailored to their methodology, velocity, and backlog.
