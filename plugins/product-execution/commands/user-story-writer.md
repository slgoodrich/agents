...
```
/pm:user-stories [feature or requirements description] [optional: context, personas]
```
...
**Related**: `/pm:prd`, `/pm:mvp`, `/pm:sprint-plan`, `/pm:backlog-groom`, `/workflows:feature-lifecycle`
