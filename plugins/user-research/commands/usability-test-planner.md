...
```
/user-research:usability-test [feature or flow] [optional: fidelity level, participant criteria]
```
...
- `/user-research:survey` - Quantitative research to complement usability testing
- `/user-research:interview-guide` - User interviews for discovery research
- `/user-research:research-synthesis` - Synthesize usability findings with other research
- `/continuous-discovery:discovery-sprint` - Use usability testing in solution validation
