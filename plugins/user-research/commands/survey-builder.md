...
```
/user-research:survey [research objective] [optional: target audience, timeline]
```
...
- `/user-research:interview-guide` - Qualitative research for deeper insights
- `/user-research:usability-test` - Test specific flows before surveying
- `/user-research:research-synthesis` - Synthesize survey results with other research
- `/continuous-discovery:discovery-sprint` - Use surveys in discovery validation
