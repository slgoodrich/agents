...
```
/user-research:research-synthesize [study name or research data] [optional: method, participants]
```
...
- `/user-research:interview-guide` - Plan user research interviews
- `/customer-insights:persona` - Create personas from research insights
- `/customer-insights:journey-map` - Map user journeys based on research
