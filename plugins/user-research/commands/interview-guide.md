...
```
/user-research:interview-guide [research objective] [optional: participant type, research phase]
```
...
- `/customer-insights:persona` - Create personas from interview insights
- `/user-research:research-synthesize` - Synthesize interview findings
- `/customer-insights:journey-map` - Map customer journey from interviews
- `/requirements-engineering:user-stories` - Convert insights into user stories
- `/user-research:usability-test` - Create usability test plan
- `/customer-insights:research-to-product` - Full research-to-roadmap workflow
