...
```
/pm:stakeholder-map [project or initiative] [optional: scope, organization context]
```
...
- `/pm:align` - Facilitate stakeholder alignment sessions
- `/pm:comm-plan` - Detailed communication planning
- `/pm:decision-log` - Document stakeholder decisions
- `/workflows:annual-planning` - Strategic stakeholder engagement
