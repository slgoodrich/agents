...
```
/pm:okr [period: Q1 2025, H1 2025, 2025] [optional: strategic focus, team]
```
...
- `/pm:roadmap` - Create product roadmap aligned to OKRs
- `/workflows:quarterly-planning` - Full quarterly planning process
- `/pm:kpi-dashboard` - Track metrics for key results
- `/pm:decision-log` - Document strategic decisions behind OKRs
