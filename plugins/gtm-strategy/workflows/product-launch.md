...
**Commands**:
```
/product-operations:release-notes [version]
...
**Commands**:
```
/user-research:interview-guide "Beta feedback sessions"
...
**Commands**:
```
/product-operations:release-notes --channel all
...
**Commands**:
```
/product-analytics:kpi-dashboard "Launch Metrics"
