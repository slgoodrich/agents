...
```
/gtm-strategy:release-plan [release version or name] [timeline]
```
...
- `/agile-coaching:sprint-plan` - Individual sprint planning
- `/strategic-planning:roadmap` - Place release on roadmap
- `/continuous-discovery:mvp` - Define MVP for release
- `/strategic-planning:risks` - Risk assessment for release
- `/gtm-strategy:product-launch` - Full product launch workflow
