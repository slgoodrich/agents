...
```
/pm:mvp [product idea or feature] [optional: target users, timeline]
```
...
- `/pm:prd` - Full PRD for MVP features
- `/pm:roadmap` - Place MVP on roadmap timeline
- `/pm:impact` - Estimate impact of MVP features
- `/pm:user-stories` - Break MVP features into user stories
- `/pm:experiment` - Design validation experiments for MVP
- `/workflows:discovery-sprint` - Validate MVP assumptions before building
