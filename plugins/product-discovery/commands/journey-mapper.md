...
```
/pm:journey-map [user persona or scenario] [optional: journey stage focus, research data]
```
...
- `/pm:persona` - Create user personas before mapping journey
- `/pm:research-synthesize` - Synthesize research into journey insights
- `/pm:interview-guide` - Create interview guide to research journey
- `/pm:usability-test` - Test specific journey stages
- `/pm:user-stories` - Convert journey opportunities into user stories
- `/workflows:research-to-product` - Journey mapping in full research workflow
