...
```
/pm:persona [target user segment or role] [optional: research data, demographics]
```
...
- `/pm:journey-map` - Map customer journey for this persona
- `/pm:interview-guide` - Create interview guide to research persona
- `/pm:research-synthesize` - Synthesize research into personas
- `/pm:user-stories` - Write user stories for this persona
- `/workflows:research-to-product` - Research-to-persona-to-roadmap workflow
