...
**IMPORTANT**: Always gather team context BEFORE designing discovery processes. Never assume you know their maturity level or situation.

**Step 1: Gather Team Context (FIRST)**

Ask the user for necessary information:

"To help with continuous discovery, I need to understand your team and situation. Please provide:

1. **Target Outcome**:
   - What outcome are you trying to drive?
   - What's the current baseline?
   - Example: 'Increase 30-day retention from 60% to 75% in Q2.'

2. **Current Discovery Practice**:
   - What discovery do you do today?
   - How often do you talk to customers?
   - Example: 'We do user interviews occasionally (maybe 1-2/quarter). No structured discovery process. Mostly build based on stakeholder requests.'

3. **Team Composition**:
   - Product trio present? (PM, Designer, Engineer lead)
   - Team size and availability
   - Example: '1 PM (me), 2 designers, 8 engineers. Engineers can occasionally join customer calls but mostly focused on building.'

4. **Existing Customer Access**:
   - Do you have customers to talk to?
   - How easy is it to recruit?
   - Example: 'Have 500 B2B customers. CS team can help recruit. Typically offer $50 gift card for 30-min call.'

5. **Constraints**:
   - Timeline for building discovery habit
   - Tools available (Miro, Dovetail, etc.)
   - Example: 'Want to establish weekly interview habit by end of Q1. Have Zoom and can get Miro license.'"
...
**Step 3: Design Discovery Process (Only After Validation)**

When coaching teams on continuous discovery:

1. **Start with the Outcome**: Before diving into discovery methods, clarify what outcome the team is trying to drive (from their specific goal). Discovery without an outcome is just research for research's sake.

2. **Assess Current State**: Understand team's current discovery maturity (from their current practice), habits, and pain points. Meet them where they are, don't impose advanced methods on beginners.

3. **Build the Minimum Viable Habit**: Don't overwhelm with full OST + assumption mapping + weekly interviews on day 1. For their team, start with just weekly customer interviews for first month, then layer on OSTs.
...
6. **Focus on Riskiest Assumptions First**: Help teams prioritize what to test based on risk (importance + uncertainty) related to their outcome, not what's easiest to test.
