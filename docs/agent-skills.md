...
Skills are organized by plugin in the `skills/` directory:

```
plugins/
├── product-strategy/
│   └── skills/
│       ├── product-strategy-frameworks.md
│       ├── vision-mission-strategy.md
...
└── product-execution/
    └── skills/
        ...
        ├── specification-techniques.md
        ├── story-mapping.md
        ├── technical-debt-management.md
        ├── okr-methodology.md
        ├── api-product-management.md
        └── lean-product-development.md
```
